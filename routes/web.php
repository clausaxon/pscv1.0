...
Route::get('/log/downloadsk/{id}', [LogController::class,'downloadsk']);
Route::get('/log/downloadstk/{id}', [LogController::class,'downloadstk']);
Route::get('/lib', [UploadLibController::class,'uploadForm']);
Route::post('/lib/upload', [UploadLibController::class,'uploadFile']);
Route::get('/lib/hapus/{id}', [UploadLibController::class,'hapus']);
Route::get('/lib/download/{id}', [UploadLibController::class,'download']);