<x-app-layout>
    <x-slot name="header" >
        <p class="text-3xl text-center">Surat Keluar PSC</p>
    </x-slot>
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <select name="jenis" class="form-control block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="jenis">
                            <option value="PSC1">Executive Director</option>
                            <option value="PSC2">Risk & Complience</option>
                            <option value="PSC3">Planner & Technical</option>
                            <option value="PSC4">CSO(Marketing)</option>
                        </select>
